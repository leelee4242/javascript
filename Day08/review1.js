const nintendo = [
    ...
    {title: "포켓몬스터", genre:["RPG", "어드벤처"], price: 64800, multiplayer: true},
    {title: "동물의 숲", genre:["RPG", "힐링"], price: 64800, multiplayer: true},
    {title: "별의 커비", genre:["액션", "어드벤처"], price: 49800, multiplayer: felse},
    {title: "슈퍼마리오 오디세이", genre:["액션", "어드벤처","아케이드"], price: 79800, multiplayer: felse},
]

//1. 가격이 60000원 이하이고, 멀티플레이가 되는 게임 리스트
const quiz1 = nintendo.filter((x)=>x.price <= 60000 && x.multiplayer == true)
